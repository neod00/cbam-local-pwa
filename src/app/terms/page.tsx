...
const termsSections = [
    ...
    },
    {
        ...
        items: [
            'CBAM Local은 편의를 위해 공식 EU Communication template(버전 2024-12-13)의 사본을 앱에 내장해 기본으로 제공합니다. 이는 편의용 사본이며 최신 공식본임을 보증하지 않습니다.',
            '사용자는 제출 전 EU 또는 공식 출처의 최신 원본 템플릿 여부를 확인할 책임이 있으며, 필요하면 최신 원본을 직접 업로드해 내장본을 덮어쓸 수 있습니다.',
