                            ...
                            <div className="mt-4 rounded-xl border border-slate-200 bg-white px-4 py-3">
                                <div className="flex items-start justify-between gap-3">
                                    <div>
                                        ...
                                        <p className="mt-1 text-xs leading-5 text-slate-600">
                                            Export 체크리스트의 SEFA·인증서 검토는 저장된 시나리오 가정값을 사용합니다.
                                        </p>
                                    </div>
                                    <Link
                                        href="/scenarios"
                                ...
                                <dl className="mt-3 grid grid-cols-1 gap-2 text-xs sm:grid-cols-3">
                                    <div className="rounded-lg bg-slate-50 px-3 py-2">
                                        ...
                                        <dd className="mt-1 font-semibold text-slate-950">{scenarioAssumptions?.default_value_year ?? '-'}</dd>
                                    </div>
                                    <div className="rounded-lg bg-slate-50 px-3 py-2">
                                        <dt className="font-semibold text-slate-500">CBAM factor</dt>
                                        <dd className="mt-1 font-semibold text-slate-950">{scenarioAssumptions?.cbam_factor ?? '-'}</dd>
                                    </div>
                                    <div className="rounded-lg bg-slate-50 px-3 py-2">
                                        <dt className="font-semibold text-slate-500">인증서 가격</dt>
