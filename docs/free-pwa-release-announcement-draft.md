...
현재 검토용 배포 URL은 `https://cbam-local-pwa.vercel.app/`이고, 공개 배포 안내 URL은 `https://cbam-local-pwa.vercel.app/announcement`, 약관/고지 초안 URL은 `https://cbam-local-pwa.vercel.app/terms`이다.
