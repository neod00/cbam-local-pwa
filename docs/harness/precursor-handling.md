...
| **스크랩 안내 (⑦)** | Q&A(zero embedded input) | 백로그(값쌈) | **선제 가능** — 다음 안내 패스에 1줄. "스크랩은 내재배출 0 → 전구물질에 넣지 않음"(윤활유 제외 옆). 규정만 30분 확인 |
...
> 선제적으로 딱 하나만 한다면 **⑦ 스크랩 안내**(가장 값싸고 오입력 예방). 나머지는 파일럿 피드백으로 트리거되면 착수.
