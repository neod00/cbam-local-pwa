...
const routes = [
  ...
  { path: '/results', label: 'Results', snippets: ['산정 결과', 'CBAM 산정 기준 SEE', '내부 검토용 total SEE'] },
  { path: '/scenarios', label: 'Scenarios', snippets: ['시나리오', 'SEFA', '인증서'] },
  { path: '/upload', label: 'Upload', snippets: ['자료 업로드', '로컬'] },
  { path: '/export', label: 'EU Export', snippets: ['EU Communication Template Export', 'Summary_Products'] },
